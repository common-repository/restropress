...
function setRevenueGraph(data, selectedValue) {
    ...
    var chartContainer = document.getElementById("revenue-graph-container");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if ('done' == response.step || response.error || response.success) {
                    ...
                    $('body').find('.rpress-export-form input[type="submit"]').removeClass('button-disabled');
                } else {
                    $('.rpress-progress div')
                        .animate({
...
function setcustomergraph(customerCount, lastcustomerCount) {
    // Check if the chart container exists
    var chartContainer = document.getElementById("rp-customer-information-graph");
    ...
    if (chartContainer) {
        var chart = new CanvasJS.Chart("rp-customer-information-graph", {
            ...
            data: [{
                ...
                dataPoints: [
                    { y: customerCount, label: "", color: "#4E4BF5", },
                    { y: lastcustomerCount, label: "", color: "#6495ED", },
