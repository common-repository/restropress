	...
	<div class="rpress-mobile-cart-icons" <?php echo  empty( rpress_get_cart_quantity() ) ? 'style="display:none"' :'' ?>>
		<div class="rp-cart-left-wrap">
			...
			<span class='rpress-cart-badge rpress-cart-quantity'>
			  <?php echo esc_html( rpress_get_cart_quantity() ); ?> <span><?php esc_html_e('Items', 'restropress'); ?></span>
			</span>
			<span class="rp-separation">&nbsp;|&nbsp;</span>
			<span class="rp-mb-price"><?php echo esc_html( rpress_currency_filter( rpress_format_amount( rpress_get_cart_total() ) ) ); ?></span>
		</div>
	...
	<div class="rpress-sidebar-main-wrap">
	    ...
	    <div class="rpress-sidebar-cart-wrap">
	    	<div class="rpress item-order">
	    		<span><?php echo esc_html( apply_filters('rpress_cart_title', __( 'Your Order', 'restropress' ) ) ); ?></span>
			...
			<ul class="rpress-cart">
				<?php if( $cart_items ) : ?>
					<?php foreach( $cart_items as $key => $item ) : ?>
						<?php echo wp_kses_post( rpress_get_cart_item_template( $key, $item, false, $data_key = '' ) ); ?>
					<?php endforeach; ?>
