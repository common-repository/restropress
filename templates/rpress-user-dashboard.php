                ...
                <div class="box-bg height-100">
                    <ul class="sidebar-menu">   
                        <li class="active user-profile">
                            <div>
                                <img src="<?php echo esc_url( RP_PLUGIN_URL . 'assets/images/user/profile.png' ); ?>" />
                                <span><?php echo  esc_html(__( 'Profile', 'restropress' ) ); ?></span>
                            </div>
                        </li>
                        <li class="user-my-orders">
                            <div>
                                <img src="<?php echo esc_url( RP_PLUGIN_URL . 'assets/images/user/my-order.png'); ?>" />
                                <span><?php echo esc_html(__( 'My Orders', 'restropress' ) ); ?></span>
                            </div>
                        </li>
                        <li class="user-my-address">
                            <div>
                                <img src="<?php echo esc_url( RP_PLUGIN_URL . 'assets/images/user/address.png'); ?>" />
                                <span><?php echo esc_html(__( 'Saved Address', 'restropress' ) ); ?></span>
                            </div>
                        </li>
                        <li class="logout">
                            <a href="<?php echo esc_url( wp_logout_url(home_url()) ); ?>">
                                <img src="<?php echo esc_url( RP_PLUGIN_URL . 'assets/images/user/logout.png' ); ?>" />
                                <span><?php echo esc_html(__( 'Logout', 'restropress' ) ); ?></span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="box-bg pd-2">
                        ...
                        <div class="flex align-items">
                            ...
                            <div class="avtar-details-wrap">
                                <?php if( !empty($userfname) && !empty($userlname) ) {
                                    ?><h2 class="avtar-name"><?php echo esc_html( $userfname." ".$userlname ); ?></h2><?php
                                } else {
                                    ?><h2 class="avtar-name"><?php echo esc_html( $username ); ?></h2><?php
                                } ?>
                                <?php if( !empty($useremail) ) {
                                    ?><p class="avtar-email"><?php echo esc_html( $useremail ); ?></p><?php
                                } ?>
                            </div>                
                        </div>             
                    </div>
                    <div class="border-solid-bg pd-2">
                        <div class="box-header">
                            <h4 class="box-title"><?php echo esc_html(__( 'Personal Information', 'restropress' ) ); ?></h4>  
                        </div>
                        <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-wrap mb-2">
                                            <input type="text" class="form-control" name="first_name" value="<?php echo esc_html( $userfname ); ?>">
                                            <label class="form-label"><?php echo esc_html(__( 'First name', 'restropress' ) ); ?></label>                                        
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-wrap mb-2">
                                            <input type="text" class="form-control" name="last_name" value="<?php echo esc_html( $userlname ); ?>">
                                            <label class="form-label"><?php echo esc_html(__( 'Last name', 'restropress' ) ); ?></label>                    
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-wrap mb-2">
                                            <input type="email" class="form-control" name="email" value="<?php echo esc_html( $useremail ); ?>">
                                            <label class="form-label"><?php echo esc_html(__( 'Email address', 'restropress' ) ); ?></label>                                        
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-wrap mb-2">
                                            <input type="text" class="form-control" name="phone" value="<?php echo esc_html( $user_phone ); ?>">
                                            <label class="form-label"><?php echo esc_html(__( 'Phone', 'restropress' ) ); ?></label>                    
                                        </div>
                                    </div>
                                </div>
                                <div class="text-end">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <div class="flex justify-content-space-between align-items-center pd-4"> 
                                    <h4 class="box-title"><?php echo esc_html(__( 'Orders', 'restropress' ) ); ?></h4>    
                                </div>
            ...
            <div class="col-lg-9 col-12" id="user-my-address" style="display:none;">        
                <div class="box-bg pd-2">
                    <div class="box-header pd-2">     
                        <h4 class="box-title"><?php echo esc_html(__( 'Saved Address', 'restropress' ) ); ?></h4>
                        <p class="box-title-description"><?php echo esc_html(__( '
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            $user_default_addresses = get_user_meta( $user_id, 'user_default_address_index', true );
                            if (!empty($user_addresses)) {
                                            ...
                                            <div class="flex justify-content-space-between items-center">
                                                ...
                                                <div class="rp-order-dropdown">
                                                    ...
                                                    <ul class="dropdown__items">
                                                        ...
                                                        </svg><?php echo esc_html(__( 'Delete', 'restropress' ) ); ?></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="address-not-found-wrap">
                                    <img src="<?php echo esc_url( RP_PLUGIN_URL . 'assets/images/user/address-not-found.png' ); ?>"/>
                            ...
                            <div class="add-address-wrap">
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary mapimg add-new-address-btn" onclick="addaddress()" id="scrollmap">
                                        ...
                                        <?php echo esc_html(__( 'Add New Address','restropress' ) ); ?>
                                    </button>
                                </div>
                                <div id="add-address-bg">
                                    <div class="box-header">
                                        <h4 class="box-title"><?php echo esc_html(__( 'Add Delivery Address', 'restropress' )); ?></h4>  
                                    </div>
                                    <div class="box-body">
                                        <form method="POST" class="profile-form-wrap">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="input-wrap mb-2">
                                                        <input type="text" class="form-control" id="fastNameInput" name="first_name" value="">
                                                        <label class="form-label"><?php echo esc_html(__( 'Fast name', 'restropress' )); ?></label>                                        
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="input-wrap mb-2">
                                                        <input type="text" class="form-control" id="lastNameInput" name="last_name" value="">
                                                        <label class="form-label"><?php echo esc_html(__( 'Last name', 'restropress' )); ?></label>                    
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="input-wrap mb-2">
                                                        <input type="text" class="form-control" id="cityAddress" name="city" value="">
                                                        <label class="form-label"><?php echo esc_html(__( 'Town / City', 'restropress' )); ?></label>                                        
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="input-wrap mb-2">
                                                        <input type="text" class="form-control" id="pincodeInput" name="pincode" value="">
                                                        <label class="form-label"><?php echo esc_html(__( 'Pincode', 'restropress' )); ?></label>                    
                                                    </div>
                                                </div>    
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="input-wrap mb-2">
                                                        <input type="text" class="form-control" id="streetaddress" name="address" value="">
                                                        <label class="form-label"><?php echo esc_html(__( 'Street Address', 'restropress' )); ?></label>                                        
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="input-wrap mb-2">
                                                        <input type="text" class="form-control" id="aptsuite" name="apt_suite" value="">
                                                        <label class="form-label"><?php echo esc_html(__( 'Apartment, suite, unit etc. (optional)', 'restropress' )); ?></label>                    
                                                    </div>
                                                </div>    
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <h6 class="address-type"><?php echo esc_html(__( 'Address Type', 'restropress' )); ?></h6>
                                                <div class="flex align-items-center">
                                                    <div>
                                                        ...
                                                        <?php echo esc_html(__( 'Home', 'restropress' )); ?></label>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <?php echo esc_html(__( 'Office', 'restropress' )); ?></label>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <?php echo esc_html(__( 'Other', 'restropress' )); ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row pt-1">
                                                <div class="col-sm-12">
                                                    <div class="default-address-checkbox pt-2">
                                                        ...
                                                        <span class="default-add-text"><?php echo esc_html(__( 'Make this my default address', 'restropress' )); ?></span>
                                                    </div>
                                                </div>
                                            </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_user_address'])) {
    ...
    if ( !empty( $existing_addresses ) ) {
        ...
        foreach ( $existing_addresses as $index => $address ) {
            if( $index == $user_default_addresses ) {
                $default_address = $existing_addresses[$index];
                $new_address = array(
