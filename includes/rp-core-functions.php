  ...
  <div class="delivery-wrap">
    <div class="delivery-opts">
      <?php if ( ! empty( $_COOKIE['service_type'] ) ) : ?>
        <span class="delMethod"><?php echo rpress_service_label( sanitize_text_field( $_COOKIE['service_type'] ) ) . ', ' . $service_date; ?></span><?php if( ! empty( $_COOKIE['service_time'] ) ) : ?><span class="delTime"><?php printf(__( ', %s', 'restropress' ), sanitize_text_field( $service_time_str ) ); ?></span><?php endif; ?>
      <?php endif; ?>
    </div>
