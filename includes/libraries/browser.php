 ...
 *
 * Modified to work for RPRESS by
 ...
 *
 * Modified to add formatted User Agent string for RPRESS System Info by
 * Chris Christoff on 12/23/2012
 * Changes: Split user string and add formatting so we can print a nicely
 * formatted user agent string on the RPRESS System Info
 *
 * File: Browser.php
