...
class RPRESS_Customer_Reports_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( array(
			'singular'  => esc_html__( 'Customer', 'restropress' ),     // Singular name of the listed records
			'plural'    => esc_html__( 'Customers', 'restropress' ),    // Plural name of the listed records
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			...
			case 'fooditems' :
				...
				$value = '<a href="' . esc_url( admin_url( 'admin.php?page=rpress-reports&tab=logs&user=' . urlencode( $user ) ) ) . '">' . esc_html__( 'View fooditem log', 'restropress' ) . '</a>';
				break;
			default:
