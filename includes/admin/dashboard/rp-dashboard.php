        ...
        <div class="row">
            <div class="rp-col-sm-9 leftbg">
                <div class="flex justify-content-space-between items-center page-header">
                    <h2 class="page-title"><?php echo esc_html__( 'Sales Overview','restropress' ); ?></h2>
                    <div class="year_select_wrap">
                        <div class="multi-column-select" data-mate-select="active">
                            <select id="rpress-dashboard-admin">
                                <option value=""><?php esc_html_e( 'Today', 'restropress' ); ?></option>
                                <option value="1"><?php esc_html_e( 'This Year', 'restropress' ); ?></option>
                                <option value="2"><?php esc_html_e( 'Yesterday', 'restropress' ); ?></option>
                                <option value="3"><?php esc_html_e( 'Last week', 'restropress' ); ?></option>
                                <option value="4"><?php esc_html_e( 'Last month', 'restropress' ); ?></option>
                                <option value="5"><?php esc_html_e( 'Last year', 'restropress' ); ?></option>
                                <option value="6"><?php esc_html_e( 'Custom', 'restropress' ); ?></option>
                            </select>
                ...
                <div class="row">
                    <div class="rp-col-sm-3 rp-col-sm-6 pr8">
                        <div class="rp-sales-overview-box box">
                            ...
                            <div class="flex items-center rp-sales-growth">
                                ...
                                <div class="rp-sales-growth-rate <?php echo esc_attr( $percentage_change < 0 ) ? 'rp-red' : 'rp-green'; ?>  ml-3"
                                    id="total-order-percentage">
                        ...
                        <div class="rp-sales-overview-box box">
                            ...
                            <div class="flex items-center rp-sales-growth">
                                ...
                                <div class="rp-sales-growth-rate <?php echo esc_html( $percentage_change_customer < 0 ) ? 'rp-red' : 'rp-green'; ?>  ml-3"
                                    ...
                                    <?php echo esc_attr( number_format( $percentage_change_customer, 2 ) ). "%"; ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="rp-col-sm-3 rp-col-sm-6 pr8 pl8">
                        <div class="rp-sales-overview-box box">
                            ...
                            <div class="flex items-center rp-sales-growth">
                                <p><?php echo esc_html__( 'Total Refund','restropress' ); ?></p>
                                <div class="rp-sales-growth-rate <?php echo esc_html( $total_refund_percentage < 0 ) ? 'rp-red' : 'rp-green'; ?>  ml-3"
                                    id="total-refund-percentage">
                                    ...
                                    <?php echo esc_html(number_format( $total_refund_percentage, 2 )) . "%"; ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="rp-col-sm-3 rp-col-sm-6 pl8">
                        <div class="rp-sales-overview-box box">
                            ...
                            <div class="flex items-center rp-sales-growth">
                                <p><?php echo esc_html__( 'Total Sales','restropress' ); ?></p>
                                <div class="rp-sales-growth-rate <?php echo esc_html( $total_sales_percentage < 0 ) ? 'rp-red' : 'rp-green'; ?>  ml-3"
                                    id="total-sales-percentage">
                                    ...
                                    <?php echo esc_html(number_format( $total_sales_percentage, 2 )) . "%"; ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-25">
                    <div class="rp-col-sm-3 rp-col-sm-6">
                        <div class="today-sale-wrap box">
                            <p><?php echo esc_html__( 'Today sales','restropress' ); ?></p>
                            <div class="flex items-center rp-sales-growth mt-1">
                                <?php
                                    ...
                                    ?>
                                <div class="rp-sale-no"><?php echo  esc_html( $today_sales_totals );  ?></div>
                                <div
                    ...
                    <div class="rp-col-sm-9 rp-col-sm-9">
                        <div class="revenue-wrap box">
                            <div class="flex justify-content-space-between">
                                <h5 class="card-title"><?php echo esc_html__( 'Revenue','restropress' ); ?></h5>
                                <div class="mt-3 flex items-center sm:ml-auto sm:mt-0">
                                    <span><?php echo esc_html__( 'Sort by:','restropress' ); ?></span>
                                    <select id="revenue-graph-selecter">
                                        <option value="monthly"><?php echo esc_html__( 'Monthly','restropress' ); ?></option>
                                        <option value="weekly"><?php echo esc_html__( 'Weekly','restropress' ); ?></option>
                                        <option value="yearly"><?php echo esc_html__( 'Yearly','restropress' ); ?></option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="row mt-25">
                    <div class="rp-col-sm-12">
                        <div class="flex justify-content-space-between items-center page-header">
                            <h2 class="page-title"><?php echo esc_html__( 'Last Orders','restropress' ); ?></h2>
                            <a href="<?php echo esc_url( home_url( '/wp-admin/admin.php?page=rpress-payment-history' ) );?>"
                                class="see-all-order"><?php echo esc_html__( 'See All','restropress' ); ?></a>
                        </div>
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="text-align-left"><?php echo esc_html__( 'Order','restropress' ); ?></th>
                                        <th class="text-align-right"><?php echo esc_html__( 'Status','restropress' ); ?></th>
                                        <th class="text-align-right"><?php echo esc_html__( 'Product(s)','restropress' ); ?>
                                        </th>
                                        <th class="text-align-right"><?php echo esc_html__( 'Category','restropress' ); ?></th>
                                        <th class="text-align-right"><?php echo esc_html__( 'Price','restropress' ); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="d-flex text-align-left">
                                            <h6 class="rp-order-id">
                                                #<?php echo esc_html($sequential_prefix . $order_id . $sequential_postfix  ); ?>
                                            </h6>
                                            <small
                                                class="rp-order-time"><?php echo esc_html(  $time_display); ?></small>
                                        </td>
                                        <td class="text-align-right">
                                            ...
                                            <?php endif; ?>
                                            <?php echo esc_html( $capitalized_order_status ); ?>
                                        </td>
                                        <td class="text-align-right">
                                            <?php 
                                        ...
                                        <td class="text-align-right">
                                            <div class="d-flex viewbg">
                                                <a href="#" class="order-preview"
                                                    data-order-id="<?php echo esc_html( $order_id ); ?>" title="Preview">
                                                    <svg width="15" height="9" viewBox="0 0 15 9" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M7.04315 0.0860729C4.56496 0.229609 2.22737 1.55658 0.364333 3.87659C-0.121932 4.48296 -0.121932 4.59134 0.367262 5.20357C2.22737 7.52651 4.57374 8.85055 7.06365 8.98823C9.87872 9.14056 12.5415 7.81065 14.6359 5.20064C15.1222 4.59427 15.1222 4.48589 14.633 3.87366C13.2738 2.1776 11.6568 1.01173 9.86993 0.440518C9.31336 0.261831 8.64255 0.132941 8.11528 0.100719C7.54113 0.0684967 7.4181 0.065568 7.04315 0.0860729ZM8.12113 1.45113C8.96184 1.60931 9.77033 2.18346 10.2097 2.93043C10.737 3.83265 10.7927 4.92236 10.3591 5.84509C10.1892 6.20539 10.0252 6.43974 9.7469 6.72681C8.17972 8.34086 5.51112 7.84873 4.60304 5.77771C4.27496 5.03074 4.2691 4.1168 4.58839 3.3376C4.89597 2.57891 5.56678 1.91689 6.33133 1.61517C6.91133 1.38668 7.49133 1.33396 8.12113 1.45113Z"
                                                            fill="#9F9F9F" />
                                                        <path
                                                            d="M7.1928 2.86892C6.71532 2.97144 6.2935 3.2673 6.0533 3.67155C5.87461 3.96741 5.81602 4.1871 5.81895 4.53862C5.81895 4.87842 5.85117 5.0161 5.98592 5.30024C6.11188 5.56095 6.47512 5.92418 6.74168 6.05307C7.68199 6.50711 8.77462 6.04428 9.11442 5.05125C9.21109 4.76711 9.21402 4.32185 9.12028 4.02599C8.90644 3.34932 8.28543 2.8777 7.57361 2.85134C7.43007 2.84548 7.25724 2.85427 7.1928 2.86892Z"
                                                            fill="#9F9F9F" />
                                                    </svg>
                                                </a>
                                            </div>
            ...
            <div class="rp-col-sm-3 rightbg">
                <div class="flex justify-content-end">
                    ...
                    <button type="button" class="btn btn-blue ml-3">
                        ...
                        <form id="rpress-export-payments" class="rpress-export-form rpress-import-export-form"
                            method="post">
                            ...
                            <input type="submit" value="<?php esc_html_e( 'Report', 'restropress' ); ?>"
                ...
                <div class="box mt-5">
                    <div class="flex justify-content-space-between items-center">
                        <div>
                            <h5 class="card-title"><?php echo esc_html__( 'Order Placed','restropress' ); ?></h5>
                        </div>
                        <div class="rp-order-dropdown">
                            <div class="custom-dropdown">
                                <i id="dropdownIcon" class="fa-solid fa-ellipsis"></i>
                                <select id="orderFrequency" class="custom-select dropdown__items">
                                    <option value="monthly"><?php echo esc_html__( 'Monthly','restropress' ); ?></option>
                                    <option value="weekly"><?php echo esc_html__( 'Weekly','restropress' ); ?></option>
                                    <option value="yearly"><?php echo esc_html__( 'Yearly','restropress' ); ?></option>
                                </select>
                    ...
                    <div class="flex items-top rp-add-product-wrap">
                        ...
                        <div class="ml-3">
                            <?php
                             ...
                             ?>
                            <div class="card-title rp-product-hd"><?php echo esc_html__( 'Total Product','restropress' ); ?>
                            </div>
                            <div class="rp-product-no"><?php echo esc_html( $count_posts->publish ); ?></div>
                        </div>
                    </div>
                ...
                <div class="box mt-6 rp-customer-information-wrap">
                    <div class="flex justify-content-space-between">
                        <div>
                            <h5 class="card-title"><?php echo esc_html__( 'Customers','restropress' ); ?></h5>
                            <div class="rp-customer-information-desc">
                                <?php echo esc_html__( 'Customers Information','restropress' ); ?></div>
                        </div>
                        <div>
                    ...
                    <div class="rp-customer-information-list mt-5 flex items-center">
                        <div>
                            <div class="mt-5">
                                <p class="rp-customer-type"><?php echo esc_html__( 'Total Customer','restropress' ); ?></p>
                                <span class="rp-customer-rate"
                                    id="customer-data"><?php echo esc_html($customer_count ) ?></span>
                            </div>
                            <div class="mt-5">
