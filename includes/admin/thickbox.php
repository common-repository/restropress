...
function rpress_media_button() {
	...
	if ( in_array( $pagenow, array( 'post.php', 'page.php', 'post-new.php', 'post-edit.php' ) ) && $typenow != 'fooditem' ) {
		...
		$output = '<a href="#TB_inline?width=640&inlineId=choose-fooditem" class="thickbox button rpress-thickbox" style="padding-left: .4em;">' . $img . sprintf( esc_html__( 'Insert %s', 'restropress' ), strtolower( rpress_get_label_singular() ) ) . '</a>';
	}
	...
	if ( in_array( $pagenow, array( 'post.php', 'page.php', 'post-new.php', 'post-edit.php' ) ) && $typenow != 'fooditem' ) { ?>
		...
		<div id="choose-fooditem" style="display: none;">
			<div class="wrap" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
				...
				<p class="submit">
					<input type="button" id="rpress-insert-fooditem" class="button-primary" value="<?php echo esc_attr(sprintf( __( 'Insert %s', 'restropress' ), rpress_get_label_singular() )); ?>" onclick="insertDownload();" />
