			...
			<div class="rp-tab-content">
				...
				rpress_text_input(
					array(
						...
						'label'     => esc_html__( 'SKU', 'restropress' ),
					)
				);
			}
				rpress_text_input(
					array(
						...
						'label'     => esc_html__( 'Price', 'restropress' ) . ' (' . rpress_currency_symbol() . ')',
				...
				rpress_checkbox(
					array(
						...
						'label'       => esc_html__( 'Variable pricing', 'restropress' ),
						'description' => esc_html__( 'Check this box if the food has multiple options and you want to specify price for different options.', 'restropress' ).' '.esc_html__( 'After adding variable pricing make sure you have save this item once to see changes in addons.', 'restropress' ),
				...
				rpress_text_input(
					array(
						...
						'label' => esc_html__( 'Price Label', 'restropress' ),
