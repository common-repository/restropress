...
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-auth-v1-controller.php';
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-orders-v1-controller.php';
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-cart-v1-controller.php';
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-customer-v1-controller.php';
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-reports-v1-controller.php';
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-food-categories-v1-controller.php';
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-food-addons-v1-controller.php';
require RP_PLUGIN_DIR . 'includes/rest-api/Controllers/Version1/class-rp-rest-others-v1-controller.php';
