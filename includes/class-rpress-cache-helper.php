...
class RPRESS_Cache_Helper {
	...
	public function init() {
		if ( false === ( $page_uris = get_transient( 'rpress_cache_excluded_uris' ) ) ) {
			...
			set_transient( 'rpress_cache_excluded_uris', $page_uris );
		}
		...
		if( function_exists( 'wp_suspend_cache_addition' ) ) {
			add_action('rpress_pre_update_discount',         array( $this, 'w3tc_suspend_cache_addition_pre' ) );
			add_action('rpress_pre_insert_discount',         array( $this, 'w3tc_suspend_cache_addition_pre' ) );
			add_action('rpress_pre_delete_discount',         array( $this, 'w3tc_suspend_cache_addition_pre' ) );
			add_action('rpress_pre_update_discount_status',  array( $this, 'w3tc_suspend_cache_addition_pre' ) );
			add_action('rpress_pre_remove_cart_discount',    array( $this, 'w3tc_suspend_cache_addition_pre' ) );
			add_action('rpress_post_update_discount',        array( $this, 'w3tc_suspend_cache_addition_post' ) );
			add_action('rpress_post_insert_discount',        array( $this, 'w3tc_suspend_cache_addition_post' ) );
			add_action('rpress_post_delete_discount',        array( $this, 'w3tc_suspend_cache_addition_post' ) );
			add_action('rpress_post_update_discount_status', array( $this, 'w3tc_suspend_cache_addition_post' ) );
			add_action('rpress_post_remove_cart_discount',   array( $this, 'w3tc_suspend_cache_addition_post' ) );
		}
	}
	/**
