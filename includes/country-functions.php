 ...
 */
function rpress_get_shop_country() {
	$country = rpress_get_option( 'base_country', 'US' );
	return apply_filters( 'rpress_shop_country', $country );
}
/**
 * Get Shop Base State
 *
 ...
 */
function rpress_get_shop_state() {
	$state = rpress_get_option( 'base_state', false );
	return apply_filters( 'rpress_shop_state', $state );
}
/**
 * Get Shop States
 *
...
function rpress_get_states( $country = null ) {
	...
	switch( $country ) :
		case 'US' :
			...
			break;
		case 'AO' :
			$states = rpress_get_angola_provinces_list();
			break;
		case 'CA' :
			$states = rpress_get_provinces_list();
			break;
		case 'AU' :
			$states = rpress_get_australian_states_list();
			break;
		case 'BD' :
			$states = rpress_get_bangladeshi_states_list();
			break;
		case 'BG' :
			$states = rpress_get_bulgarian_states_list();
			break;
		case 'BR' :
			$states = rpress_get_brazil_states_list();
			break;
		case 'CN' :
			$states = rpress_get_chinese_states_list();
			break;
		case 'GB' :
			$states = rpress_get_united_kingdom_states_list();
			break;
		case 'HK' :
			$states = rpress_get_hong_kong_states_list();
			break;
		case 'HU' :
			$states = rpress_get_hungary_states_list();
			break;
		case 'ID' :
			$states = rpress_get_indonesian_states_list();
			break;
		case 'IN' :
			$states = rpress_get_indian_states_list();
			break;
		case 'IR' :
			$states = rpress_get_iranian_states_list();
			break;
		case 'IT' :
			$states = rpress_get_italian_states_list();
			break;
		case 'JP' :
			$states = rpress_get_japanese_states_list();
			break;
		case 'MX' :
			$states = rpress_get_mexican_states_list();
			break;
		case 'MY' :
			$states = rpress_get_malaysian_states_list();
			break;
		case 'NP' :
			$states = rpress_get_nepalese_states_list();
			break;
		case 'NZ' :
			$states = rpress_get_new_zealand_states_list();
			break;
		case 'PE' :
			$states = rpress_get_peruvian_states_list();
			break;
		case 'TH' :
			$states = rpress_get_thailand_states_list();
			break;
		case 'TR' :
			$states = rpress_get_turkey_states_list();
			break;
		case 'ZA' :
			$states = rpress_get_south_african_states_list();
			break;
		case 'ES' :
			$states = rpress_get_spain_states_list();
			break;
		default :
			$states = array();
			break;
	endswitch;
	return apply_filters( 'rpress_shop_states', $states, $country );
}
/**
 * Get Country List
 *
 ...
 */
function rpress_get_country_list() {
	$countries = array(
		''   => '',
		'US' => 'United States',
		'CA' => 'Canada',
	...
	return apply_filters( 'rpress_countries', $countries );
}
/**
 * Get States List
 *
 ...
 * @return      array
 */
function rpress_get_states_list() {
	$states = array(
		''   => '',
		'AL' => 'Alabama',
		'AK' => 'Alaska',
	...
	return apply_filters( 'rpress_us_states', $states );
}
/**
 * Get Angola States
 *
 ...
 */
function rpress_get_angola_provinces_list() {
	$provinces = array(
		''    => '',
		'BGO' => 'Bengo',
		'BGU' => 'Benguela',
	...
	return apply_filters( 'rpress_angola_provinces', $provinces );
}
/**
 * Get Provinces List
 *
 ...
 * @return      array
 */
function rpress_get_provinces_list() {
	$provinces = array(
		''   => '',
		'AB' => 'Alberta',
		'BC' => 'British Columbia',
	...
	return apply_filters( 'rpress_canada_provinces', $provinces );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_australian_states_list() {
	$states = array(
		''    => '',
	...
	return apply_filters( 'rpress_australian_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_bangladeshi_states_list() {
	$states = array(
		''    => '',
		'BAG' => 'Bagerhat',
		'BAN' => 'Bandarban',
	...
	return apply_filters( 'rpress_bangladeshi_states', $states );
}
/**
 * Get Brazil States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_brazil_states_list() {
	$states = array(
		''   => '',
		'AC' => 'Acre',
		'AL' => 'Alagoas',
	...
	return apply_filters( 'rpress_brazil_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_bulgarian_states_list() {
	$states = array(
		''      => '',
		'BG-01' => 'Blagoevgrad',
		'BG-02' => 'Burgas',
	...
	return apply_filters( 'rpress_bulgarian_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_hong_kong_states_list() {
	$states = array(
		''                => '',
	...
	return apply_filters( 'rpress_hong_kong_states', $states );
}
/**
 * Get Hungary States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_hungary_states_list() {
	$states = array(
		''   => '',
		'BK' => 'Bács-Kiskun',
		'BE' => 'Békés',
	...
	return apply_filters( 'rpress_hungary_states', $states );
}
/**
 * Get Japanese States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_japanese_states_list() {
	$states = array(
		''     => '',
		'JP01' => 'Hokkaido',
		'JP02' => 'Aomori',
	...
	return apply_filters( 'rpress_japanese_states', $states );
}
/**
 * Get Chinese States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_chinese_states_list() {
	$states = array(
		''     => '',
	    'CN1'  => 'Yunnan / &#20113;&#21335;',
	    'CN2'  => 'Beijing / &#21271;&#20140;',
	...
	return apply_filters( 'rpress_chinese_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_united_kingdom_states_list() {
	$states = array(
	    ''	    	 => '',
	...
	return apply_filters( 'rpress_united_kingdom_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_new_zealand_states_list() {
	$states = array(
		''   => '',
		'AK' => 'Auckland',
		'BP' => 'Bay of Plenty',
	...
	return apply_filters( 'rpress_new_zealand_states', $states );
}
/**
 * Get Peruvian States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_peruvian_states_list() {
	$states = array(
		''    => '',
		'CAL' => 'El Callao',
	...
	return apply_filters( 'rpress_peruvian_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_indonesian_states_list() {
	$states  = array(
		''   => '',
	...
	return apply_filters( 'rpress_indonesia_states', $states );
}
/**
 * Get Indian States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_indian_states_list() {
	$states = array(
		''   => '',
		'AP' => 'Andhra Pradesh',
	...
	return apply_filters( 'rpress_indian_states', $states );
}
/**
 * Get Iranian States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_iranian_states_list() {
	$states = array(
		''    => '',
		'KHZ' => 'Khuzestan',
		'THR' => 'Tehran',
	...
	return apply_filters( 'rpress_iranian_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_italian_states_list() {
	$states = array(
		''   => '',
		'AG' => 'Agrigento',
		'AL' => 'Alessandria',
	...
	return apply_filters( 'rpress_italian_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_malaysian_states_list() {
	$states = array(
		''    => '',
		'JHR' => 'Johor',
		'KDH' => 'Kedah',
	...
	return apply_filters( 'rpress_malaysian_states', $states );
}
/**
 * Get Mexican States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_mexican_states_list() {
	$states = array(
		''    => '',
	...
	return apply_filters( 'rpress_mexican_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_nepalese_states_list() {
	$states = array(
		''    => '',
		'ILL' => 'Illam',
		'JHA' => 'Jhapa',
	...
	return apply_filters( 'rpress_nepalese_states', $states );
}
/**
 ...
 * @return array $states A list of states
 */
function rpress_get_south_african_states_list() {
	$states = array(
		''    => '',
		'EC'  => 'Eastern Cape',
		'FS'  => 'Free State',
	...
	return apply_filters( 'rpress_south_african_states', $states );
}
/**
 * Get Thailand States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_thailand_states_list() {
	$states = array(
		''      => '',
	...
	return apply_filters( 'rpress_thailand_states', $states );
}
/**
 * Get Turkey States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_turkey_states_list() {
	$states = array(
		''     => '',
		'TR01' => 'Adana',
		'TR02' => 'Ad&#305;yaman',
	...
	return apply_filters( 'rpress_turkey_states', $states );
}
/**
 * Get Spain States
 *
 ...
 * @return array $states A list of states
 */
function rpress_get_spain_states_list() {
	$states = array(
		''   => '',
	    'C'  => __( 'A Coru&ntilde;a', 'restropress' ),
	    'VI' => __( 'Araba', 'restropress' ),
	    'AB' => __( 'Albacete', 'restropress' ),
	    'A'  => __( 'Alicante', 'restropress' ),
	    'AL' => __( 'Almer&iacute;a', 'restropress' ),
	    'O'  => __( 'Asturias', 'restropress' ),
	    'AV' => __( '&Aacute;vila', 'restropress' ),
	    'BA' => __( 'Badajoz', 'restropress' ),
	    'PM' => __( 'Baleares', 'restropress' ),
	    'B'  => __( 'Barcelona', 'restropress' ),
	    'BU' => __( 'Burgos', 'restropress' ),
	    'CC' => __( 'C&aacute;ceres', 'restropress' ),
	    'CA' => __( 'C&aacute;diz', 'restropress' ),
	    'S'  => __( 'Cantabria', 'restropress' ),
	    'CS' => __( 'Castell&oacute;n', 'restropress' ),
	    'CE' => __( 'Ceuta', 'restropress' ),
	    'CR' => __( 'Ciudad Real', 'restropress' ),
	    'CO' => __( 'C&oacute;rdoba', 'restropress' ),
	    'CU' => __( 'Cuenca', 'restropress' ),
	    'GI' => __( 'Girona', 'restropress' ),
	    'GR' => __( 'Granada', 'restropress' ),
	    'GU' => __( 'Guadalajara', 'restropress' ),
	    'SS' => __( 'Gipuzkoa', 'restropress' ),
	    'H'  => __( 'Huelva', 'restropress' ),
	    'HU' => __( 'Huesca', 'restropress' ),
	    'J'  => __( 'Ja&eacute;n', 'restropress' ),
	    'LO' => __( 'La Rioja', 'restropress' ),
	    'GC' => __( 'Las Palmas', 'restropress' ),
	    'LE' => __( 'Le&oacute;n', 'restropress' ),
	    'L'  => __( 'Lleida', 'restropress' ),
	    'LU' => __( 'Lugo', 'restropress' ),
	    'M'  => __( 'Madrid', 'restropress' ),
	    'MA' => __( 'M&aacute;laga', 'restropress' ),
	    'ML' => __( 'Melilla', 'restropress' ),
	    'MU' => __( 'Murcia', 'restropress' ),
	    'NA' => __( 'Navarra', 'restropress' ),
	    'OR' => __( 'Ourense', 'restropress' ),
	    'P'  => __( 'Palencia', 'restropress' ),
	    'PO' => __( 'Pontevedra', 'restropress' ),
	    'SA' => __( 'Salamanca', 'restropress' ),
	    'TF' => __( 'Santa Cruz de Tenerife', 'restropress' ),
	    'SG' => __( 'Segovia', 'restropress' ),
	    'SE' => __( 'Sevilla', 'restropress' ),
	    'SO' => __( 'Soria', 'restropress' ),
	    'T'  => __( 'Tarragona', 'restropress' ),
	    'TE' => __( 'Teruel', 'restropress' ),
	    'TO' => __( 'Toledo', 'restropress' ),
	    'V'  => __( 'Valencia', 'restropress' ),
	    'VA' => __( 'Valladolid', 'restropress' ),
	    'BI' => __( 'Bizkaia', 'restropress' ),
	    'ZA' => __( 'Zamora', 'restropress' ),
	    'Z'  => __( 'Zaragoza', 'restropress' )
	);
	return apply_filters( 'rpress_spain_states', $states );
}
/**
 ...
 * @return string
 */
function rpress_get_country_name( $country_code = '' ) {
	$country_list = rpress_get_country_list();
	$country_name = isset( $country_list[ $country_code ] ) ? $country_list[ $country_code ] : $country_code;
	return apply_filters( 'rpress_get_country_name', $country_name, $country_code );
}
/**
