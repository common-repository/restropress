...
class RPRESS_DB_Customer_Meta extends RPRESS_DB {
	/**
	 * Get things started
	 *
	 * @since 1.0
	*/
	public function __construct() {
		global $wpdb;
		$this->table_name  = $wpdb->prefix . 'rpress_customermeta';
	...
	*/
	 ...
	 *
	 * For internal use only. Use RPRESS_Customer->get_meta() for public usage.
	 *
	 ...
	 *
	 * For internal use only. Use RPRESS_Customer->add_meta() for public usage.
	 *
	 * @param   int    $customer_id   Customer ID.
	 ...
	 *
	 * For internal use only. Use RPRESS_Customer->update_meta() for public usage.
	 *
	 ...
	 *
	 * For internal use only. Use RPRESS_Customer->delete_meta() for public usage.
	 *
